...
(function ($) {
    ...
    if (device_width > 767 && typeof ScrollSmoother !== "undefined") {
        const smoothWrapper = document.querySelector("#has_smooth");
        if (smoothWrapper && smoothWrapper.classList.contains("has-smooth")) {
